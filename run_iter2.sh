...
POLICY_MODEL=$PROJECT_ROOT/outputs/gemma-2-9b-it_mnpo_stage_2_armo
POLICY_MODEL_T_2=$PROJECT_ROOT/outputs/gemma-2-9b-it_mnpo_stage_1_armo
...
PREF_DIR=$PROJECT_ROOT/data/mnpo_iter2_armo/pref
